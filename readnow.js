...
function makeReadable() {
	...
	function styleTarget(target, prefs) {
		...
		styles = parseStyles("font-size:16px,font-family:'Iosevka Term',webkitFontSmoothing:subpixel-antialiased");
		styleElements(elements, styles);
		...
		styles = parseStyles("font-weight:700,font-family:'NYTImperial',webkitFontSmoothing:subpixel-antialiased");
		styleElements(elements, styles);
	}
